...
const gMails = [
  {
    ...
    title: [
      `This is your day yaeli, make it legendary. 
  ...
  last few months as people explore what’s new:`,
      `“I have been playing with the Canva Video Editor today. You NEED to try it to see how awesome it really is. 
  💯 @Canva is truly becoming a one-stop shop for creativity!`,
      `“Whaaatt!!?? You can now SCREEN RECORD in @canva Just another reason to love it!”`,
      `Thanks to our community for sharing your #canvalove
  ...
  And I can't guarantee this offer will be open tomorrow.`,
      `Since inception in 2002, our flagship service's average stock pick has returned over 683%, which is more than quadruple the return of the market!
  ...
  },
  {
    ...
    title: [
      `Real Rewards by American Eagle & Aerie members earn points on purchases (after discounts and before taxes and fees) made at American Eagle Outfitters® and Aerie®. Click here for Real Rewards by American Eagle & Aerie terms and conditions. See Real Rewards by American Eagle & Aerie terms and conditions to end your membership in Real Rewards. If you end your membership, you will no longer receive your free benefits, points towards rewards and email updates.
  `,
  ...
  *Cardholder offers are subject to credit approval and a Real Rewards credit card must be used as the sole payment type. See here for details.
  ...
  Buy now`,
      'Would love to catch up sometimes Would love to catch up sometimes ',
...
async function query() {
  return await storageService.query(EMAILS_KEY);
}

function _createMails() {
  let mails = storageService.query(EMAILS_KEY);
  if (!mails.length) {
    mails = gMails;
