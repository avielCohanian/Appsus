...
<script>
  import bookRate from '../cmps/book-rate.vue';
  import longText from '../cmps/long-txt.vue';
    ...
    watch: {
      '$route.params.bookId': {
        handler() {
          ...
          bookService.getPreviousBookId(bookId).then((bookId) => (this.previousBookId = bookId));
        },
        immediate: true,
      },
    },
